...
col1.metric('Revenue', str(stats['revenue']['#']) + 'S', str(stats['revenue']['%']) + '%')
col2.metric('Gross Profit', str(stats['gross profit']['#']) + 'S', str(stats['gross profit']['%']) + '%')
col3.metric('Net Income', str(stats['net income']['#']) + 'S', str(stats['net income']['%']) + '%')
st.write('_______')

coll1, coll2, coll3, coll4, coll5 = st.columns(5)
coll1.metric('Employee 1', str(employee['A']['Salary']) + 'S',str(employee['A']['diff']) + 'S',delta_color='off' )
coll3.metric('Employee 2', str(employee['C']['Salary']) + 'S',str(employee['D']['diff']) + 'S',delta_color='off' )
coll2.metric('Employee 3', str(employee['B']['Salary']) + 'S',str(employee['B']['diff']) + 'S',delta_color='off' )
coll4.metric('Employee 4', str(employee['D']['Salary']) + 'S',str(employee['C']['diff']) + 'S',delta_color='off' )
coll5.metric('Employee 5', str(employee['E']['Salary']) + 'S',str(employee['E']['diff']) + 'S',delta_color='off' )
st.write('_______')

col1n, col2n, col3n = st.columns(3)
col1n.metric('Operating Cost',str(stats['Operating Cost']['#']) + 'S', str(stats['Operating Cost']['%']) + '%', delta_color='off')
col2n.metric('Employee Cost',str(stats['Employee Cost']['#']) + 'S', str(stats['Employee Cost']['%']) + '%', delta_color='off')
col3n.metric('Bank Debt',str(stats['Bank Debt']['#']) + 'S', str(stats['Bank Debt']['%']) + '%', delta_color='off')
